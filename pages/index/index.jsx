...
class Section1 extends Component{
	render(){return(
		<section style={{background:"rgba(0,0,0,0.4)",textAlign:"center",height:700,position:"relative",padding:"200px 0 50px 0",color:"#fff"}}>
			...
			<a style={{textDecoration:"none",background:"#3ab0e2",cursor:"pointer",color:"#fff",width:470,display:"inline-block",lineHeight:"40px",verticalAlign:"middle"}} target="_blank" href="http://wpa.qq.com/msgrd?v=3&site=qq&menu=yes">联系我们</a>
		...
		<section style={{background:"#105153",color:"#fff",padding:"100px 0",textAlign:"center"}}>
			...
			{[1,2,3].map(it=>(
				<div key={Math.random()} style={{display:"inline-block",padding:"1.5%",width:"25%",verticalAlign:"top"}}>
					<div style={{borderBottom:"1px solid",lineHeight:"40px"}}>&nbsp;</div>
					<div style={{textAlign:"right",color:"#AAA",margin:10}}>&nbsp;</div>
					<p style={{minHeight:300}}>&nbsp;</p>
				</div>
			))}
...
class Footer extends Component{
	render(){return(
		<section style={{background:"#272727",color:"#fff",textAlign:"center"}}>
			{[
				{k:"公司地址",v:"···",icon:SocialLocationCity,color:"#34d293"},
				{k:"关于我们",v:"···",icon:ImageTagFaces,color:"#f7d861"},
				{k:"联系电话",v:"···",icon:CommunicationCall,color:"#e96656"},
				{k:"版权所有",v:"···",icon:ActionCopyright,color:"#3ab0e2"}
			].map(it=>(
